  ...
  return (
    <div className="dining">
      <section className="dining-hero">
        ...
        <p>
          Ob gemütliches Restaurant, schneller Snack oder Kaffee mit Aussicht – im Zoo finden Sie
          vielfältige Verpflegungsmöglichkeiten für jeden Geschmack und jedes Budget.
        </p>
        <p>
          Mit Ihrem Besuch in den Restaurants und Shops unterstützen Sie gleichzeitig die
          Naturschutzprojekte des Zoos, denn ein fester Anteil der Einnahmen fliesst direkt in diese
          Arbeit.
        </p>
      </section>
      ...
      <section className="dining-section">
        ...
        <p className="dining-section-intro">
          Geniessen Sie eine Pause in einem unserer Restaurants – von klassischer Küche über
          Selbstbedienung bis hin zu thematisch gestalteten Lokalen.
        </p>
      ...
      <section className="dining-section">
        ...
        <p className="dining-section-intro">
          Für den kurzen Halt zwischen zwei Tieranlagen bieten verschiedene Stände und Kioske eine
          unkomplizierte Auswahl an Snacks und Getränken.
        </p>
        <div className="dining-grid">
      ...
      <section className="dining-section dining-section-alt">
        <div className="dining-two-column">
          <div>
            ...
            <p>
              Im Zoo gibt es ausgewiesene Picknickbereiche, in denen Sie Ihre eigene Verpflegung
              geniessen können. Bitte achten Sie darauf, den Abfall korrekt zu entsorgen und die
              Tiere nicht zu füttern.
            </p>
          </div>
          <div>
            <h3>Nachhaltige Gastronomie</h3>
            <p>
              Die Gastronomie im Zoo setzt auf einen verantwortungsvollen Umgang mit Ressourcen,
              saisonale Produkte und kurze Transportwege, wo immer möglich. So wird Ihr
              Restaurantbesuch zum Genuss mit gutem Gewissen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="dining-section">
        ...
        <p>
          Für Firmenanlässe, Geburtstage oder andere Feiern stehen verschiedene Locations und
          Catering-Angebote zur Verfügung. In Kombination mit einer Führung oder einem
          Spezialprogramm wird Ihr Anlass im Zoo zu einem besonderen Erlebnis.
        </p>
      </section>
    </div>
  );
